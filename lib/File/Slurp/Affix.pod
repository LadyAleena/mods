...
B<File::Slurp::Affix> opens a file and creates an array with an optional prefix, suffix, or both in your preferred encoding.

=head1 VERSION

This document describes File::Slurp::Affix version 1.0.
...
=head1 SYNOPSIS
  ...
  my @joiner_array  = slurp_affix($file, { 'prefix' => 'foo', 'suffix' => 'bar', 'joiner' => ' ' });
...
=head4 joiner
  ...
  my @joiner_array = slurp_affix($file, { 'prefix' => 'solid', 'suffix' => 'bead', 'joiner' => ' ' });
