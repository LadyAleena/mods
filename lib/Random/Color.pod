...
Random::Color depends on L<Fancy::Rand>, L<Fancy::Open>, L<File::ShareDir>, and L<Exporter>.

=head1 SEE ALSO

More random colors can be found in L<Random::GemMetalJewelry>, L<Random::Color::Hex>, L<Random::Color::VisiBone>, and L<Random::Color::Web>.
