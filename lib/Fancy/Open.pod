...
If the open fails, fancy_open will die.
  ...
  my @fancy_array = fancy_open($file, { 'prefix' => $prefix_value, 'suffix' => $suffix_value });
...
The C<empty> option has three possible values: C<fill>, C<blank>, or C<undefined>. If C<empty> is not used or is any value than the three listed, the empty line will be ignored.
