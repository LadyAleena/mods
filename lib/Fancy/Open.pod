...
The second parameter are the options: C<prefix>, C<suffix>, C<joiner>, C<empty>, and C<encoding>.
...
The C<empty> option has three possible values: C<fill>, C<blank>, or C<undefined>.
